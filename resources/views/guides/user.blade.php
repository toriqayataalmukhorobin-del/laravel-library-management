            ...
            <div class="card shadow-lg border-0" style="border-radius: 20px; overflow: hidden;">
                <div class="card-header py-4 text-white" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h3 class="mb-0 fw-bold" style="font-size: 1.5rem;">Panduan Pengguna</h3>
                            <p class="mb-0" style="opacity: 0.9; font-size: 0.9rem;">Panduan lengkap menggunakan sistem PerpustakaanKU</p>
                        </div>
                    </div>
                </div>
