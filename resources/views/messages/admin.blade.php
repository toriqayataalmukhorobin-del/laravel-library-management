            ...
            <div class="card shadow-lg border-0" style="border-radius: 20px; overflow: hidden;">
                <div class="card-header py-4 text-white" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h3 class="mb-0 fw-bold" style="font-size: 1.5rem;">Pesan Masuk</h3>
                            <p class="mb-0" style="opacity: 0.9; font-size: 0.9rem;">Kelola pesan dari user</p>
                        </div>
                    </div>
                </div>
                <div class="card-body p-5">
                    ...
                    @if ($messages->isEmpty())
                        <div class="text-center py-5">
                            <div style="width: 100px; height: 100px; background: linear-gradient(135deg, rgba(240, 147, 251, 0.1), rgba(245, 87, 108, 0.1)); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 1.5rem;">
                            ...
                            <p class="text-muted">Tidak ada pesan dari user saat ini</p>
                        </div>
                    @else
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="padding: 1rem;">
                                            ...
                                            <div class="text-muted" style="font-size: 0.85rem;">{{ $message->user->username }}</div>
                                        </td>
                                        <td style="padding: 1rem;">
                                            <div class="fw-semibold" style="color: var(--text-primary);">{{ $message->subject }}</div>
                                            <div class="text-muted" style="font-size: 0.85rem;">{{ Str::limit($message->message, 60) }}</div>
                                        </td>
                                        <td style="padding: 1rem;">
                                        ...
                                        <td style="padding: 1rem;" class="text-center">
                                            <a href="{{ route('messages.show', $message->id) }}" class="btn btn-sm btn-outline-primary rounded-3">
